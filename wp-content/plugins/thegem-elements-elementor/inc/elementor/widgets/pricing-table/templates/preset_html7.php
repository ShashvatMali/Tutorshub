...
<div class="pricing-table <?php echo esc_attr('pricing-table-style-'.$preset); ?> button-icon-default">
		...
		<?php if ( 'yes' === $settings['content_header_show'] || 'yes' === $settings['content_pricing_show']) : ?>
				...
				<?php if ( 'yes' === $settings['content_header_show'] ) : ?>
					<div class="pricing-price-title-wrapper">
						<?php if ( ! empty( $settings['content_header_title'] ) ) : ?>
							<?php echo thegem_get_data( $settings, 'content_header_title', '', '<div class="pricing-price-title"><span ' .  $this->get_render_attribute_string( 'content_header_title' )  . '>', '</span></div>' ); ?>
						<?php endif; ?>
				...
				<?php endif; ?>
					...
					<svg class="wrap-style">
						<use xlink:href="<?php echo esc_url( THEGEM_ELEMENTOR_WIDGET_PRICING_TABLE_URL ); ?>/assets/img/post-arrow.svg#dec-post-arrow">
						</use>
					</svg>
				</div>
				<?php endif; ?>
				...
				<div class="pricing-footer">
					<div class="gem-button-container gem-button-position-center <?php echo esc_attr('footer-align-' . $settings['style_footer_align']); ?>">
						<a class="gem-button gem-button-text-weight-thin <?php if ( !empty( $settings['style_footer_button_icon']['value'] )) 
						...
						<?php if(!empty( $settings['content_footer_button_link']['url'])) {
							$this->add_link_attributes( 'footer_button', $settings['content_footer_button_link'] );
							$this->print_render_attribute_string( 'footer_button' );
						} ?>
						>
