			...
			<div class="pricing-column">
				...
				<?php if ( 'yes' === $settings['content_header_show'] ) : ?>
					<div class="pricing-price-title-wrapper">
						...
						<?php if ( ! empty( $settings['content_header_subtitle'] ) ) : ?>
							<?php echo thegem_get_data( $settings, 'content_header_subtitle', '', '<div class="pricing-price-subtitle header-align-' . $settings['style_header_align'] . '"><span ' .  $this->get_render_attribute_string( 'content_header_subtitle' )  . '>', '</span></div>' ); ?>
						<?php endif; ?>
					</div>
				<?php endif; ?>
				...
				<?php if ( 'yes' === $settings['content_pricing_show'] ) : ?>
					<div class="pricing-price-wrapper">
						<div class="pricing-price <?php echo esc_attr('pricing-align-'.$settings['style_pricing_align']); ?>">
