	...
	<div class="pricing-table <?php echo esc_attr('pricing-table-style-'.$preset); ?> button-icon-default">
		<div class="pricing-column-wrapper">
			...
			<?php if ( 'yes' === $settings['content_label_show'] ) : ?>
				<div class="pricing-column-top-choice <?php echo esc_attr('label-align-' . $settings['style_label_2d_align']); ?>">
			...
			<?php if ( 'yes' === $settings['content_pricing_show'] ) : ?>
				...
				<?php if ( 'yes' === $settings['content_header_show'] ) : ?>
					...
					<?php if ( ! empty( $settings['content_header_subtitle'] ) ) : ?>
						<div class="pricing-row pricing-row-title">
							<?php echo thegem_get_data( $settings, 'content_header_subtitle', '', '<div class="pricing_row_title"><span ' .  $this->get_render_attribute_string( 'content_header_subtitle' )  . '>', '</span></div>' ); ?>
						</div>
					<?php endif; ?>
				<?php endif; ?>
				...
				<div class="pricing-footer">
					<div class="gem-button-container gem-button-position-center <?php echo esc_attr('footer-align-' . $settings['style_footer_align']); ?>">
						...
						<a class="gem-button gem-button-text-weight-thin gem-button-border-1 <?php if ( !empty( $settings['style_footer_button_icon']['value'] )) 
