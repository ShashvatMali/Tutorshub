...
class TheGem_Section_Parallax {
	...
	public function __construct() {
		...
		add_action('elementor/element/container/section_background/after_section_end', array($this, 'after_section_end'), 10, 2);
	...
	public function enqueue_scripts() {
		...
		if (!empty($this->parallax_sections) || !empty($GLOBALS['thegem_parallax_activate']) || \Elementor\Plugin::$instance->preview->is_preview_mode()) {
