	...
	protected function image_styles($control)
	{
		...
		$control->add_responsive_control(
			...
			[
				...
				'selectors_dictionary' => [
					'left' => 'float: left;',
					'right' => 'float: right;',
					'centered' => 'float: none; text-align: center; margin-left: auto; margin-right: auto;'
				],
				'selectors' => [
					'{{WRAPPER}} .gem-image.gem-wrapbox' => '{{VALUE}}',
				],
				'toggle' => false,
				'default' => 'left',
				'frontend_available' => true,
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .gem-image a i, {{WRAPPER}} .gem-image a svg' => 'color: {{VALUE}};',
				],
				'conditions' => [
			   	'relation' => 'or',
				'terms' => [
		...
		$control->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .gem-image a i, {{WRAPPER}} .gem-image a svg' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};
		...
		$control->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .gem-image a i, {{WRAPPER}} .gem-image a svg' => 'transform: rotate({{SIZE}}deg); -webkit-transform: rotate({{SIZE}}deg);',
				],
				'conditions' => [
			   	'relation' => 'or',
				'terms' => [
...
*/
	...
	public function render()
	{
		...
		$image_url = $image_id ? Group_Control_Image_Size::get_attachment_image_src($image_id, 'imagesize', $settings) : $settings['image']['url'];
