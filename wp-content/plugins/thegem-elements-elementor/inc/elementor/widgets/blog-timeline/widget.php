	...
	protected function image_styles( $control ) {
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => true,
				'selectors' => [
					'{{WRAPPER}} .blogtimeline.blog-style-timeline.blog-style-timeline_new .post-item-outer .post-pic a' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',	
				],
				'condition' => [
					'thegem_elementor_preset' => [ 'timeline_new'],
				],
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .post-pic a',
				'fields_options' => [
					'width' => [
						'default' => [
							'top' => '1',
		...
		$control->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .post-pic' => 'opacity: calc({{SIZE}}/100);',
				],
			]
		);
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .post-pic a img',
			]
		);
		...
		$control->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .post-pic img' => 'mix-blend-mode: {{VALUE}}',
				],
				'separator' => 'none',
			]
		);
			...
			[
				...
				'fields_options' => [
					...
					'color' => [
						...
						'selectors' => [
							'{{WRAPPER}} .blogtimeline .post-item-outer .caption-container .post-pic a:hover::before' => 'background: {{VALUE}} !important;',
						],
					],
					'gradient_angle' => [
						'selectors' => [
							'{{WRAPPER}} .blogtimeline .post-item-outer .caption-container .post-pic a:hover:before' => 'background-color: transparent; background-image: linear-gradient({{SIZE}}{{UNIT}}, {{color.VALUE}} {{color_stop.SIZE}}{{color_stop.UNIT}}, {{color_b.VALUE}} {{color_b_stop.SIZE}}{{color_b_stop.UNIT}}) !important;',
						],
					],
				]
		...
		$control->add_group_control(
			...
			[
				...
				'label' => __('CSS Filters', 'thegem'),
				'selector' => '{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .post-pic a:hover img',
			]
		);
		...
		$control->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .post-pic:hover' => 'mix-blend-mode: {{VALUE}}',
				],
				'separator' => 'none',
			]
		);
		...
		$control->add_responsive_control(
			...
			[
				...
				'default' => '#FFFFFF',
				'selectors' => [
					'{{WRAPPER}} .blogtimeline .post-item-outer .post-pic a:after' => 'color: {{VALUE}};',
				],
				'condition' => [
					'image_icon_show' => 'yes',
				],
		...
		$control->add_responsive_control(
			...
			[
				...
				'default' => '#3c3950',
				'selectors' => [
					'{{WRAPPER}} .blogtimeline .post-item-outer .post-pic a:after' => 'background-color: {{VALUE}};',
				],
				'condition' => [
					'image_icon_show' => 'yes',
				],
		...
		$control->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .blogtimeline .post-item-outer .post-pic a:after' => 'font-size: {{SIZE}}{{UNIT}};',
				],
				'condition' => [
					'image_icon_show' => 'yes',
				],
		...
		$control->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .blogtimeline .post-item-outer .post-pic a:after' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}}; line-height: {{SIZE}}{{UNIT}}; margin-top: calc(-{{SIZE}}{{UNIT}} / 2); margin-left: calc(-{{SIZE}}{{UNIT}} / 2)',
				],
				'condition' => [
					'image_icon_show' => 'yes',
				],
		...
		$control->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .blogtimeline .post-item-outer .post-pic a:after' => 'transform: rotate({{SIZE}}deg); -webkit-transform: rotate({{SIZE}}deg);',
				],
				'condition' => [
					'image_icon_show' => 'yes',
				],
	...
	protected function image_container_styles( $control ) {
		...
		$control->add_group_control(
			...
			[
				...
				'types' => ['classic', 'gradient'],
				'selector' => '{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .post-image',
			]
		);
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => true,
				'selectors' => [
					'{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .post-image' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => true,
				'selectors' => [
					'{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .post-image' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
	...
	protected function caption_styles( $control ) {
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .entry-title a',
				'condition' => [
					'show_title' => 'yes',
				],
			]
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .entry-title a' => 'color: {{VALUE}};',
				],
				'condition' => [
					'show_title' => 'yes',
				],
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .caption-container:hover .entry-title a',
				'condition' => [
					'show_title' => 'yes',
				],
			]
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .caption-container:hover .entry-title a' => 'color: {{VALUE}};',
				],
				'condition' => [
					'show_title' => 'yes',
				],
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .summary',
				'condition' => [
					'show_description' => 'yes',
				],
			]
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .summary' => 'color: {{VALUE}} !important;',
				],
				'condition' => [
					'show_description' => 'yes',
				],
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .caption-container:hover .summary',
				'condition' => [
					'show_description' => 'yes',
				],
			]
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .caption-container:hover .summary' => 'color: {{VALUE}} !important;',
				],
				'condition' => [
					'show_description' => 'yes',
				],
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .entry-title-date',
				'condition' => [
					'show_date' => 'yes',
					'thegem_elementor_preset' => [ 'timeline' ],
				],
		...
		$control->add_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .entry-title-date' => 'color: {{VALUE}} !important;',
				],
				'condition' => [
					'show_date' => 'yes',
					'thegem_elementor_preset' => [ 'timeline' ],
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .caption-container:hover .entry-title-date',
				'condition' => [
					'show_date' => 'yes',
					'thegem_elementor_preset' => [ 'timeline' ],
				],
		...
		$control->add_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .caption-container:hover .entry-title-date' => 'color: {{VALUE}} !important;',
				],
				'condition' => [
					'show_date' => 'yes',
					'thegem_elementor_preset' => [ 'timeline' ],
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .post-meta-categories a',
				'condition' => [
					'thegem_elementor_preset' => 'timeline',
					'show_categories' => 'yes',
				],
		...
		$control->add_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .post-meta-categories a' => 'color: {{VALUE}} !important;',
				],
				'condition' => [
					'thegem_elementor_preset' => 'timeline',
					'show_categories' => 'yes',
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .caption-container:hover .post-meta-categories a',
				'condition' => [
					'thegem_elementor_preset' => 'timeline',
					'show_categories' => 'yes',
				],
		...
		$control->add_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .caption-container:hover .post-meta-categories a' => 'color: {{VALUE}} !important;',
				],
				'condition' => [
					'thegem_elementor_preset' => 'timeline',
					'show_categories' => 'yes',
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .post-meta-author',
				'condition' => [
					'show_author' => 'yes',
				],
			]
		...
		$control->add_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .post-meta-author' => 'color: {{VALUE}} !important;',
				],
				'condition' => [
					'show_author' => 'yes',
				],
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .caption-container:hover .post-meta-author',
				'condition' => [
					'show_author' => 'yes',
				],
			]
		...
		$control->add_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .caption-container:hover .post-meta-author' => 'color: {{VALUE}} !important;',
				],
				'condition' => [
					'show_author' => 'yes',
				],
		...
		$control->add_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .sep' => 'border-color: {{VALUE}} !important;',
				],
			]
		);
		...
		$control->add_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .caption-container:hover .sep' => 'border-color: {{VALUE}} !important;',
				],
			]
		);
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .zilla-likes::before' => 'color: {{VALUE}} !important;',
					'{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .post-meta-likes i' => 'color: {{VALUE}} !important;',
					'{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .post-meta-likes svg' => 'fill: {{VALUE}} !important;',
				],
				'condition' => [
					'show_likes' => 'yes',
				],
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .zilla-likes-count',
				'condition' => [
					'show_likes' => 'yes',
				],
			]
		...
		$control->add_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .zilla-likes-count' => 'color: {{VALUE}};',
				],
				'condition' => [
					'show_likes' => 'yes',
				],
		...
		$control->add_responsive_control(
			...
			[
				...
				'default' => '#393d50',
				'selectors' => [
					'{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .zilla-likes::before:hover' => 'color: {{VALUE}} !important;',
					'{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .post-meta-likes i:hover' => 'color: {{VALUE}} !important;',
					'{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .post-meta-likes svg:hover' => 'fill: {{VALUE}} !important;',
				],
				'condition' => [
					'show_likes' => 'yes',
				],
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .zilla-likes-count:hover',
				'condition' => [
					'show_likes' => 'yes',
				],
			]
		...
		$control->add_control(
			...
			[
				...
				'default' => '#393d50',
				'selectors' => [
					'{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .zilla-likes-count:hover' => 'color: {{VALUE}};',
				],
				'condition' => [
					'show_likes' => 'yes',
				],
		...
		$control->add_responsive_control(
			...
			[
				...
				'default' => '#99a9b5',
				'selectors' => [
					'{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .comments-link .elementor-icon i' => 'color: {{VALUE}} !important;',
				],
				'condition' => [
					'show_comments' => 'yes',
				],
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .comments-link a',
				'condition' => [
					'show_comments' => 'yes',
				],
			]
		...
		$control->add_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .comments-link a' => 'color: {{VALUE}};',
				],
				'condition' => [
					'image_icon_show' => 'yes',
				],
		...
		$control->add_responsive_control(
			...
			[
				...
				'default' => '#00bcd4',
				'selectors' => [
					'{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .comments-link .elementor-icon i:hover' => 'color: {{VALUE}} !important;',
				],
				'condition' => [
					'show_comments' => 'yes',
				],
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .comments-link a:hover',
				'condition' => [
					'show_comments' => 'yes',
				],
			]
		...
		$control->add_control(
			...
			[
				...
				'default' => '#00bcd4',
				'selectors' => [
					'{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .comments-link a:hover' => 'color: {{VALUE}};',
				],
				'condition' => [
					'image_icon_show' => 'yes',
				],
	...
	protected function caption_container_styles( $control ) {
		...
		$control->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .blogtimeline .post-item-outer .caption-container .post-title' => 'text-align: {{VALUE}}',
					'{{WRAPPER}} .blogtimeline .post-item-outer .caption-container .post-content' => 'text-align: {{VALUE}}',
					'{{WRAPPER}} .blogtimeline .post-item-outer .caption-container .post-misc' => 'text-align: {{VALUE}}',
				],
			]
		);
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => true,
				'selectors' => [
					'{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .caption-container' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => true,
				'selectors' => [
					'{{WRAPPER}} .blogtimeline:not(.blog-style-timeline_new) .post-item-outer:not(.sticky) .caption-container' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .blogtimeline.blog-style-timeline_new .post-item-outer:not(.sticky) .post-text-wrap' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$control->add_group_control(
			...
			[
				...
				'label' => __('Shadow', 'thegem'),
				'selector' => '{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .caption-container',
			]
		);
		...
		$control->add_group_control(
			...
			[
				...
				'fields_options' => [
					...
					'color' => [
						'selectors' => [
							'{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .caption-container' => 'background: {{VALUE}} !important;',
							'{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .wrap-style' => 'fill: {{VALUE}} !important;',
						],
					],
					'gradient_angle' => [
						'selectors' => [
							'{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .caption-container' => 'background-color: transparent; background-image: linear-gradient({{SIZE}}{{UNIT}}, {{color.VALUE}} {{color_stop.SIZE}}{{color_stop.UNIT}}, {{color_b.VALUE}} {{color_b_stop.SIZE}}{{color_b_stop.UNIT}}) !important;',
						],
					],
				]
			...
			[
				...
				'fields_options' => [
					'color' => [
						'default' => thegem_get_option('box_border_color'),
						'selectors' => [
							'{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .caption-container' => 'border-color: {{VALUE}} !important;',
							'{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .wrap-style' => 'stroke: {{VALUE}} !important;',
						],
					],
					'width' => [
						'default' => [
						...
						'selectors' => [
							'{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .caption-container' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
							'{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .wrap-style' => 'stroke-width: {{TOP}}{{UNIT}} !important;',
						],
					],
				],
			]
		...
		$control->add_group_control(
			...
			[
				...
				'fields_options' => [
					...
					'color' => [
						'selectors' => [
							'{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .caption-container:hover' => 'background: {{VALUE}} !important;',
							'{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .caption-container:hover .wrap-style' => 'fill: {{VALUE}} !important;',
						],
					],
					'gradient_angle' => [
						'selectors' => [
							'{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .caption-container:hover' => 'background-color: transparent; background-image: linear-gradient({{SIZE}}{{UNIT}}, {{color.VALUE}} {{color_stop.SIZE}}{{color_stop.UNIT}}, {{color_b.VALUE}} {{color_b_stop.SIZE}}{{color_b_stop.UNIT}}) !important;',
						],
					],
				]
			]
			...
			[
				...
				'fields_options' => [
					'color' => [
						'default' => thegem_get_option('box_border_color'),
						'selectors' => [
							'{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .caption-container:hover' => 'border-color: {{VALUE}} !important;',
							'{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .caption-container:hover .wrap-style' => 'stroke: {{VALUE}} !important;',
						],
					],
					'width' => [
						'default' => [
						...
						'selectors' => [
							'{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .caption-container:hover' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
							'{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .caption-container:hover .wrap-style' => 'stroke-width: {{TOP}}{{UNIT}} !important;',
						],
					],
				],
			]
		...
		$control->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .post-title' => 'margin-top: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$control->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .post-title' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$control->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .blogtimeline .post-item-outer:not(.sticky) .summary' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
			]
		);
	...
	protected function timeline_left_styles( $control ) {
		...
		$control->add_responsive_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .blogtimeline.blog-style-timeline .post-item-outer .post-pic' => 'border-color: {{VALUE}} !important;',
		...
		$control->add_responsive_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .blogtimeline.blog-style-timeline .post-item-outer .post-pic' => 'border-width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => true,
				'selectors' => [
					'{{WRAPPER}} .blog-style-timeline .post-item-outer .post-pic' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$control->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .blogtimeline .post-item-outer .post-pic a img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .blogtimeline .post-item-outer .post-pic a' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',	
				],
			]
		);
		...
		$control->add_group_control(
			...
			[
				...
				'label' => __('Border', 'thegem'),
				'selector' => '{{WRAPPER}} .blogtimeline .post-item-outer .post-pic a',
				'fields_options' => [
					'border' => [
						'default' => 'solid',
					],
	...
	protected function sticky_post_containers_styles( $control ) {
		...
		$control->add_group_control(
			...
			[
				...
				'label' => __('Background Type', 'thegem'),
				'types' => ['classic', 'gradient'],
				'selector' => '{{WRAPPER}} .blogtimeline .post-item-outer.sticky .post-image',
				'condition' => [
					'thegem_elementor_preset' => 'timeline_new',
					'show_featured_image' => 'yes',
				],
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => true,
				'selectors' => [
					'{{WRAPPER}} .blogtimeline .post-item-outer.sticky .post-image' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'condition' => [
					'thegem_elementor_preset' => 'timeline_new',
					'show_featured_image' => 'yes',
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => true,
				'selectors' => [
					'{{WRAPPER}} .blogtimeline .post-item-outer.sticky .post-image' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'condition' => [
					'thegem_elementor_preset' => 'timeline_new',
					'show_featured_image' => 'yes',
		...
		$control->add_group_control(
			...
			[
				...
				'fields_options' => [
					...
					'color' => [
						'selectors' => [
							'{{WRAPPER}} .blogtimeline .post-item-outer.sticky .caption-container' => 'background: {{VALUE}} !important;',
							'{{WRAPPER}} .blogtimeline .post-item-outer.sticky .wrap-style' => 'fill: {{VALUE}} !important;',
						],
					],
					'gradient_angle' => [
						'selectors' => [
							'{{WRAPPER}} .blogtimeline .post-item-outer.sticky .caption-container' => 'background-color: transparent; background-image: linear-gradient({{SIZE}}{{UNIT}}, {{color.VALUE}} {{color_stop.SIZE}}{{color_stop.UNIT}}, {{color_b.VALUE}} {{color_b_stop.SIZE}}{{color_b_stop.UNIT}}) !important;',
						],
					],
				]
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => true,
				'selectors' => [
					'{{WRAPPER}} .blogtimeline .post-item-outer.sticky .caption-container' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$control->add_group_control(
			...
			[
				...
				'label' => __('Border', 'thegem'),
				'selector' => '{{WRAPPER}} .blogtimeline .post-item-outer.sticky .caption-container',
				'fields_options' => [
					'color' => [
						'default' => thegem_get_option('box_border_color'),
						'selectors' => [
							'{{WRAPPER}} .blogtimeline .post-item-outer.sticky .caption-container' => 'border-color: {{VALUE}} !important;',
							'{{WRAPPER}} .blogtimeline .post-item-outer.sticky .wrap-style' => 'stroke: {{VALUE}} !important;',
						],
					],
					'width' => [
						'default' => [
						...
						'selectors' => [
							'{{WRAPPER}} .blogtimeline .post-item-outer.sticky .caption-container' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
							'{{WRAPPER}} .blogtimeline .post-item-outer.sticky .wrap-style' => 'stroke-width: {{TOP}}{{UNIT}} !important;',
						],
					],
				],
			]
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => true,
				'selectors' => [
					'{{WRAPPER}} .blogtimeline:not(.blog-style-timeline_new) .post-item-outer.sticky .caption-container' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .blogtimeline.blog-style-timeline_new .post-item-outer.sticky .post-text-wrap' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
	...
	protected function sticky_post_captions_styles( $control ) {
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .blogtimeline .post-item-outer.sticky .entry-title span.light, {{WRAPPER}} .blogtimeline .post-item-outer.sticky .entry-title span.light a, {{WRAPPER}} .blogtimeline .post-item-outer.sticky .entry-title, {{WRAPPER}} .blogtimeline .post-item-outer.sticky .entry-title a',
				'condition' => [
					'show_title' => 'yes',
				],
			]
		...
		$control->add_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .blogtimeline .post-item-outer.sticky .entry-title span.light, {{WRAPPER}} .blogtimeline .post-item-outer.sticky .entry-title span.light a, {{WRAPPER}} .blogtimeline .post-item-outer.sticky .entry-title, {{WRAPPER}} .blogtimeline .post-item-outer.sticky .entry-title a' => 'color: {{VALUE}};',
				],
				'condition' => [
					'show_title' => 'yes',
				],
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .blogtimeline .post-item-outer.sticky .caption-container:hover .entry-title span.light, {{WRAPPER}} .blogtimeline .post-item-outer.sticky .caption-container:hover .entry-title span.light a, {{WRAPPER}} .blogtimeline .post-item-outer.sticky .caption-container:hover .entry-title, {{WRAPPER}} .blogtimeline .post-item-outer.sticky .caption-container:hover .entry-title a',
				'condition' => [
					'show_title' => 'yes',
				],
			]
		...
		$control->add_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .blogtimeline .post-item-outer.sticky .caption-container:hover .entry-title span.light, {{WRAPPER}} .blogtimeline .post-item-outer.sticky .caption-container:hover .entry-title span.light a, {{WRAPPER}} .blogtimeline .post-item-outer.sticky .caption-container:hover .entry-title, {{WRAPPER}} .blogtimeline .post-item-outer.sticky .caption-container:hover .entry-title a' => 'color: {{VALUE}};',
				],
				'condition' => [
					'show_title' => 'yes',
				],
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .blogtimeline .post-item-outer.sticky .summary',
				'condition' => [
					'show_description' => 'yes',
				],
			]
		...
		$control->add_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .blogtimeline .post-item-outer.sticky .summary' => 'color: {{VALUE}} !important;',
				],
				'condition' => [
					'show_description' => 'yes',
				],
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .blogtimeline .post-item-outer.sticky .caption-container:hover .summary',
				'condition' => [
					'show_description' => 'yes',
				],
			]
		...
		$control->add_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .blogtimeline .post-item-outer.sticky .caption-container:hover .summary' => 'color: {{VALUE}} !important;',
				],
				'condition' => [
					'show_description' => 'yes',
				],
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .blogtimeline .post-item-outer.sticky .entry-title-date',
				'condition' => [
					'show_date' => 'yes',
				],
			]
		...
		$control->add_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .blogtimeline .post-item-outer.sticky .entry-title-date' => 'color: {{VALUE}} !important;',
				],
				'condition' => [
					'show_date' => 'yes',
				],
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .blogtimeline .post-item-outer.sticky .caption-container:hover .entry-title-date',
				'condition' => [
					'show_date' => 'yes',
				],
			]
		...
		$control->add_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .blogtimeline .post-item-outer.sticky .caption-container:hover .entry-title-date' => 'color: {{VALUE}} !important;',
				],
				'condition' => [
					'show_date' => 'yes',
				],
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .blogtimeline .post-item-outer.sticky .post-meta-categories a',
				'condition' => [
					'thegem_elementor_preset' => 'timeline',
					'show_categories' => 'yes',
				],
		...
		$control->add_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .blogtimeline .post-item-outer.sticky .post-meta-categories a' => 'color: {{VALUE}} !important;',
				],
				'condition' => [
					'thegem_elementor_preset' => 'timeline',
					'show_categories' => 'yes',
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .blogtimeline .post-item-outer.sticky .caption-container:hover .post-meta-categories a',
				'condition' => [
					'thegem_elementor_preset' => 'timeline',
					'show_categories' => 'yes',
				],
		...
		$control->add_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .blogtimeline .post-item-outer.sticky .caption-container:hover .post-meta-categories a' => 'color: {{VALUE}} !important;',
				],
				'condition' => [
					'thegem_elementor_preset' => 'timeline',
					'show_categories' => 'yes',
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .blogtimeline .post-item-outer.sticky .post-meta-author',
				'condition' => [
					'show_author' => 'yes',
				],
			]
		...
		$control->add_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .blogtimeline .post-item-outer.sticky .post-meta-author' => 'color: {{VALUE}} !important;',
				],
				'condition' => [
					'show_author' => 'yes',
				],
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .blogtimeline .post-item-outer.sticky .caption-container:hover .post-meta-author',
				'condition' => [
					'show_author' => 'yes',
				],
			]
		...
		$control->add_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .blogtimeline .post-item-outer.sticky .caption-container:hover .post-meta-author' => 'color: {{VALUE}} !important;',
				],
				'condition' => [
					'show_author' => 'yes',
				],
		...
		$control->add_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .blogtimeline .post-item-outer.sticky .sep' => 'border-color: {{VALUE}} !important;',
				],
			]
		);
		...
		$control->add_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .blogtimeline .post-item-outer.sticky .caption-container:hover .sep' => 'border-color: {{VALUE}} !important;',
				],
			]
		);
		...
		if ( 'yes' === ( $settings['show_pagination'] ) ) : ?>
			...
			<?php if ( $settings['pagination_type'] == 'numbers' ) : ?>
				...
				<div class="blogtimeline-pagination" data-page="<?php echo esc_attr( $paged ); ?>" data-next-page="<?php echo esc_attr( $next_page ); ?>">
					<?php if ( $settings['pagination_type'] == 'numbers' ): ?>
						<?php $this->thegem_blogtimeline_pagination( $news_grid_loop ); ?>
					<?php endif; ?>
				</div>
			<?php endif; ?>
