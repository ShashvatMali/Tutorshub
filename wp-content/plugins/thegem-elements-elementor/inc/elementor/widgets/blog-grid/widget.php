	...
	protected function masonry_general_styles( $control ) {
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .blog-grid.blog-style-masonry .post-item:not(.sticky) .post-content-wrapper',
			]
		);
	...
	protected function justified_general_styles( $control ) {
		...
		$control->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .blog-grid.blog-style-justified .post-item .caption-container .post-title' => 'text-align: {{VALUE}}',
					'{{WRAPPER}} .blog-grid.blog-style-justified .post-item .caption-container .post-text' => 'text-align: {{VALUE}}',
					'{{WRAPPER}} .blog-grid.blog-style-justified .post-item .caption-container .info' => 'text-align: {{VALUE}}',
				],
			]
		);
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => true,
				'selectors' => [
					'{{WRAPPER}} .blog-grid.blog-style-justified .post-item:not(.sticky) .post-content-wrapper' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => true,
				'selectors' => [
					'{{WRAPPER}} .blog-grid.blog-style-justified .post-item:not(.sticky) .description' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .blog-grid.blog-style-justified .post-item:not(.sticky) .post-content-wrapper',
			]
		);
			...
			[
				...
				'fields_options' => [
					...
					'color' => [
						'default' => '#F2F5F6',
						'selectors' => [
							'{{WRAPPER}} .blog-grid.blog-style-justified .post-item .post-content-wrapper' => 'background: {{VALUE}} !important;',
						],
					],
					'gradient_angle' => [
						'selectors' => [
							'{{WRAPPER}} .blog-grid.blog-style-justified .post-item .post-content-wrapper' => 'background-color: transparent; background-image: linear-gradient({{SIZE}}{{UNIT}}, {{color.VALUE}} {{color_stop.SIZE}}{{color_stop.UNIT}}, {{color_b.VALUE}} {{color_b_stop.SIZE}}{{color_b_stop.UNIT}}) !important;',
						],
					],
				]
			...
			[
				...
				'fields_options' => [
					'color' => [
						...
						'selectors' => [
							'{{WRAPPER}} .blog-grid.blog-style-justified .post-item:not(.sticky) .post-content-wrapper' => 'border-color: {{VALUE}} !important;',
						],
					],
					'width' => [
						'default' => [
						...
						'selectors' => [
							'{{WRAPPER}} .blog-grid.blog-style-justified .post-item:not(.sticky) .post-content-wrapper' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
						],
					],
				],
			]
		...
		$control->add_group_control(
			...
			[
				...
				'fields_options' => [
					...
					'color' => [
						'selectors' => [
							'{{WRAPPER}} .blog-grid.blog-style-justified .post-item:not(.sticky) .post-content-wrapper:hover' => 'background: {{VALUE}} !important;',
						],
					],
					'gradient_angle' => [
						'selectors' => [
							'{{WRAPPER}} .blog-grid.blog-style-justified .post-item:not(.sticky) .post-content-wrapper:hover' => 'background-color: transparent; background-image: linear-gradient({{SIZE}}{{UNIT}}, {{color.VALUE}} {{color_stop.SIZE}}{{color_stop.UNIT}}, {{color_b.VALUE}} {{color_b_stop.SIZE}}{{color_b_stop.UNIT}}) !important;',
						],
					],
				]
		...
		$control->add_group_control(
			...
			[
				...
				'label' => __('Border', 'thegem'),
				'selector' => '{{WRAPPER}} .blog-grid .post-item:not(.sticky) .post-content-wrapper:hover',
				'fields_options' => [
					'color' => [
						'default' => thegem_get_option('box_border_color'),
						'selectors' => [
							'{{WRAPPER}} .blog-grid.blog-style-justified .post-item:not(.sticky) .post-content-wrapper:hover' => 'border-color: {{VALUE}} !important;',
						],
					],
					'width' => [
						'default' => [
						...
						'selectors' => [
							'{{WRAPPER}} .blog-grid.blog-style-justified .post-item:not(.sticky) .post-content-wrapper:hover' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
						],
					],
				],
			]
		...
		$control->add_group_control(
			...
			[
				...
				'label' => __('Common Shadow', 'thegem'),
				'selector' => '{{WRAPPER}} .blog-grid.blog-style-justified .post-item:not(.sticky) .post-content-wrapper:hover',
			]
		);
		...
		$control->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .blog-grid.blog-style-justified .post-item:not(.sticky) .post-title' => 'margin-top: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$control->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .blog-grid.blog-style-justified .post-item:not(.sticky) .post-title' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$control->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .blog-grid.blog-style-justified .post-item:not(.sticky) .summary' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
			]
		);
	...
	protected function image_styles( $control ) {
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => true,
				'selectors' => [
					'{{WRAPPER}} .blog-grid .post-item .post-image a img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .blog-grid .post-item .post-image a' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$control->add_group_control(
			...
			[
				'name' => 'image_border',
				'label' => __('Border', 'thegem'),
				'selector' => '{{WRAPPER}} .blog-grid .post-item:not(.sticky) .post-image a img',
				'fields_options' => [
					'color' => [
						'default' => thegem_get_option('box_border_color'),
					],
		...
		$control->add_group_control(
			...
			[
				'name' => 'image_shadow',
				'label' => __('Shadow', 'thegem'),
				'selector' => '{{WRAPPER}} .blog-grid .post-item:not(.sticky) .post-image a',
			]
		);
		...
		$control->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .blog-grid .post-item:not(.sticky) .post-image' => 'opacity: calc({{SIZE}}/100);',
				],
			]
		);
		...
		$control->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .blog-grid .post-item:not(.sticky) .post-image img' => 'mix-blend-mode: {{VALUE}}',
				],
				'separator' => 'none',
			]
		);
			...
			[
				...
				'fields_options' => [
					...
					'color' => [
						...
						'selectors' => [
							'{{WRAPPER}} .blog-grid .post-item .post-content-wrapper:hover .post-image a:before' => 'background: {{VALUE}} !important;',
						],
					],
					'gradient_angle' => [
						'selectors' => [
							'{{WRAPPER}} .blog-grid .post-item .post-content-wrapper:hover .post-image a:before' => 'background-color: transparent; background-image: linear-gradient({{SIZE}}{{UNIT}}, {{color.VALUE}} {{color_stop.SIZE}}{{color_stop.UNIT}}, {{color_b.VALUE}} {{color_b_stop.SIZE}}{{color_b_stop.UNIT}}) !important;',
						],
					],
				]
		...
		$control->add_group_control(
			...
			[
				...
				'label' => __('CSS Filters', 'thegem'),
				'selector' => '{{WRAPPER}} .blog-grid .post-item:not(.sticky) .post-content-wrapper:hover .post-image a img',
			]
		);
		...
		$control->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .blog-grid .post-item:not(.sticky) .post-content-wrapper:hover .post-image' => 'mix-blend-mode: {{VALUE}}',
				],
				'separator' => 'none',
			]
		);
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .blog-grid .post-item:not(.sticky) .post-image a:after' => 'color: {{VALUE}};',
				],
				'condition' => [
					'image_icon_show' => 'yes',
				],
		...
		$control->add_responsive_control(
			...
			[
				...
				'default' => '#3c3950',
				'selectors' => [
					'{{WRAPPER}} .blog-grid .post-item:not(.sticky) .post-image a:after' => 'background-color: {{VALUE}};',
				],
				'condition' => [
					'image_icon_show' => 'yes',
				],
		...
		$control->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .blog-grid .post-item:not(.sticky) .post-image a:after' => 'font-size: {{SIZE}}{{UNIT}};',
				],
				'condition' => [
					'image_icon_show' => 'yes',
				],
		...
		$control->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .blog-grid .post-item:not(.sticky) .post-image a:after' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}}; line-height: {{SIZE}}{{UNIT}}; margin-top: calc(-{{SIZE}}{{UNIT}} / 2); margin-left: calc(-{{SIZE}}{{UNIT}} / 2)',
				],
				'condition' => [
					'image_icon_show' => 'yes',
				],
		...
		$control->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .blog-grid .post-item:not(.sticky) .post-image a:after' => 'transform: rotate({{SIZE}}deg); -webkit-transform: rotate({{SIZE}}deg);',
				],
				'condition' => [
					'image_icon_show' => 'yes',
				],
	...
	protected function image_container_styles( $control ) {
		...
		$control->add_group_control(
			...
			[
				...
				'types' => ['classic', 'gradient'],
				'selector' => '{{WRAPPER}} .blog-grid .post-item:not(.sticky) .post-image',
			]
		);
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => true,
				'selectors' => [
					'{{WRAPPER}} .blog-grid .post-item:not(.sticky) .post-image' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => true,
				'selectors' => [
					'{{WRAPPER}} .blog-grid .post-item:not(.sticky) .post-image' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
	...
	protected function caption_styles( $control ) {
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .blog-grid .post-item:not(.sticky) .entry-title span.light, {{WRAPPER}} .blog-grid .post-item:not(.sticky) .entry-title span.light a',
				'condition' => [
					'show_title' => 'yes',
				],
			]
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .blog-grid .post-item:not(.sticky) .post-content-wrapper .entry-title span.light, {{WRAPPER}} .blog-grid .post-item:not(.sticky) .post-content-wrapper .entry-title span.light a' => 'color: {{VALUE}};',
				],
				'condition' => [
					'show_title' => 'yes',
				],
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .blog-grid .post-item:not(.sticky) .post-content-wrapper:hover .entry-title a',
				'condition' => [
					'show_title' => 'yes',
				],
			]
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .blog-grid .post-item:not(.sticky) .post-content-wrapper:hover .entry-title a' => 'color: {{VALUE}};',
				],
				'condition' => [
					'show_title' => 'yes',
				],
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .blog-grid .post-item:not(.sticky) .summary',
				'condition' => [
					'show_description' => 'yes',
				],
			]
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .blog-grid .post-item:not(.sticky) .summary' => 'color: {{VALUE}} !important;',
				],
				'condition' => [
					'show_description' => 'yes',
				],
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .blog-grid .post-item:not(.sticky) .post-content-wrapper:hover .summary',
				'condition' => [
					'show_description' => 'yes',
				],
			]
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .blog-grid .post-item:not(.sticky) .post-content-wrapper:hover .summary' => 'color: {{VALUE}} !important;',
				],
				'condition' => [
					'show_description' => 'yes',
				],
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .blog-grid .post-item:not(.sticky) .entry-title-date',
				'condition' => [
					'show_date' => 'yes',
				],
			]
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .blog-grid .post-item:not(.sticky) .entry-title-date' => 'color: {{VALUE}} !important;',
				],
				'condition' => [
					'show_date' => 'yes',
				],
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .blog-grid .post-item:not(.sticky) .post-content-wrapper:hover .entry-title-date',
				'condition' => [
					'show_date' => 'yes',
				],
			]
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .blog-grid .post-item:not(.sticky) .post-content-wrapper:hover .entry-title-date' => 'color: {{VALUE}} !important;',
				],
				'condition' => [
					'show_date' => 'yes',
				],
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .blog-grid .post-item:not(.sticky) .post-meta-author',
				'condition' => [
					'show_author' => 'yes',
				],
			]
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .blog-grid .post-item:not(.sticky) .post-meta-author' => 'color: {{VALUE}} !important;',
				],
				'condition' => [
					'show_author' => 'yes',
				],
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .blog-grid .post-item:not(.sticky) .post-content-wrapper:hover .post-meta-author',
				'condition' => [
					'show_author' => 'yes',
				],
			]
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .blog-grid .post-item:not(.sticky) .post-content-wrapper:hover .post-meta-author' => 'color: {{VALUE}} !important;',
				],
				'condition' => [
					'show_author' => 'yes',
				],
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .blog-grid .post-item:not(.sticky) .sep' => 'border-color: {{VALUE}} !important;',
				],
			]
		);
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .blog-grid .post-item:not(.sticky) .post-content-wrapper:hover .sep' => 'border-color: {{VALUE}} !important;',
				],
			]
		);
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .blog-grid .post-item:not(.sticky) .zilla-likes::before' => 'color: {{VALUE}} !important;',
					'{{WRAPPER}} .blog-grid .post-item:not(.sticky) .post-meta-likes i' => 'color: {{VALUE}} !important;',
					'{{WRAPPER}} .blog-grid .post-item:not(.sticky) .post-meta-likes svg' => 'fill: {{VALUE}} !important;',
				],
				'condition' => [
					'show_likes' => 'yes',
				],
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .blog-grid .post-item:not(.sticky) .zilla-likes-count',
				'condition' => [
					'show_likes' => 'yes',
				],
			]
		...
		$control->add_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .blog-grid .post-item:not(.sticky) .zilla-likes-count' => 'color: {{VALUE}};',
				],
				'condition' => [
					'show_likes' => 'yes',
				],
		...
		$control->add_responsive_control(
			...
			[
				...
				'default' => '#393d50',
				'selectors' => [
					'{{WRAPPER}} .blog-grid .post-item:not(.sticky) .zilla-likes::before:hover' => 'color: {{VALUE}} !important;',
					'{{WRAPPER}} .blog-grid .post-item:not(.sticky) .post-meta-likes i:hover' => 'color: {{VALUE}} !important;',
					'{{WRAPPER}} .blog-grid .post-item:not(.sticky) .post-meta-likes svg:hover' => 'fill: {{VALUE}} !important;',
				],
				'condition' => [
					'show_likes' => 'yes',
				],
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .blog-grid .post-item:not(.sticky) .zilla-likes-count:hover',
				'condition' => [
					'show_likes' => 'yes',
				],
			]
		...
		$control->add_control(
			...
			[
				...
				'default' => '#393d50',
				'selectors' => [
					'{{WRAPPER}} .blog-grid .post-item:not(.sticky) .zilla-likes-count:hover' => 'color: {{VALUE}};',
				],
				'condition' => [
					'show_likes' => 'yes',
				],
		...
		$control->add_responsive_control(
			...
			[
				...
				'default' => '#99a9b5',
				'selectors' => [
					'{{WRAPPER}} .blog-grid .post-item:not(.sticky) .comments-link .elementor-icon i' => 'color: {{VALUE}} !important;',
				],
				'condition' => [
					'show_comments' => 'yes',
				],
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .blog-grid .post-item:not(.sticky) .comments-link a',
				'condition' => [
					'show_comments' => 'yes',
				],
			]
		...
		$control->add_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .blog-grid .post-item:not(.sticky) .comments-link a' => 'color: {{VALUE}};',
				],
				'condition' => [
					'image_icon_show' => 'yes',
				],
		...
		$control->add_responsive_control(
			...
			[
				...
				'default' => '#00bcd4',
				'selectors' => [
					'{{WRAPPER}} .blog-grid .post-item:not(.sticky) .comments-link .elementor-icon i:hover' => 'color: {{VALUE}} !important;',
				],
				'condition' => [
					'show_comments' => 'yes',
				],
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .blog-grid .post-item:not(.sticky) .comments-link a:hover',
				'condition' => [
					'show_comments' => 'yes',
				],
			]
		...
		$control->add_control(
			...
			[
				...
				'default' => '#00bcd4',
				'selectors' => [
					'{{WRAPPER}} .blog-grid .post-item:not(.sticky) .comments-link a:hover' => 'color: {{VALUE}};',
				],
				'condition' => [
					'image_icon_show' => 'yes',
				],
	...
	protected function caption_container_styles( $control ) {
		...
		$control->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .blog-grid.blog-style-masonry .post-item .caption-container .post-title' => 'text-align: {{VALUE}}',
					'{{WRAPPER}} .blog-grid.blog-style-masonry .post-item .caption-container .post-text' => 'text-align: {{VALUE}}',
					'{{WRAPPER}} .blog-grid.blog-style-masonry .post-item .caption-container .info' => 'text-align: {{VALUE}}',
				],
			]
		);
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => true,
				'selectors' => [
					'{{WRAPPER}} .blog-grid.blog-style-masonry .post-item:not(.sticky) .description' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => true,
				'selectors' => [
					'{{WRAPPER}} .blog-grid.blog-style-masonry .post-item:not(.sticky) .description' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$control->add_group_control(
			...
			[
				...
				'label' => __('Shadow', 'thegem'),
				'selector' => '{{WRAPPER}} .blog-grid.blog-style-masonry .post-item:not(.sticky) .description',
			]
		);
		...
		$control->add_group_control(
			...
			[
				...
				'fields_options' => [
					...
					'color' => [
						'selectors' => [
							'{{WRAPPER}} .blog-grid.blog-style-masonry .post-item:not(.sticky) .description' => 'background: {{VALUE}} !important;',
						],
					],
					'gradient_angle' => [
						'selectors' => [
							'{{WRAPPER}} .blog-grid.blog-style-masonry .post-item:not(.sticky) .description' => 'background-color: transparent; background-image: linear-gradient({{SIZE}}{{UNIT}}, {{color.VALUE}} {{color_stop.SIZE}}{{color_stop.UNIT}}, {{color_b.VALUE}} {{color_b_stop.SIZE}}{{color_b_stop.UNIT}}) !important;',
						],
					],
				]
		...
		$control->add_group_control(
			...
			[
				...
				'label' => __('Border', 'thegem'),
				'selector' => '{{WRAPPER}} .blog-grid .post-item:not(.sticky) .description',
				'fields_options' => [
					'color' => [
						'default' => thegem_get_option('box_border_color'),
						'selectors' => [
							'{{WRAPPER}} .blog-grid.blog-style-masonry .post-item:not(.sticky) .description' => 'border-color: {{VALUE}} !important;',
						],
					],
					'width' => [
						'default' => [
						...
						'selectors' => [
							'{{WRAPPER}} .blog-grid.blog-style-masonry .post-item:not(.sticky) .description' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
						],
					],
				],
			]
		...
		$control->add_group_control(
			...
			[
				...
				'fields_options' => [
					...
					'color' => [
						'selectors' => [
							'{{WRAPPER}} .blog-grid.blog-style-masonry .post-item:not(.sticky) .post-content-wrapper:hover .description' => 'background: {{VALUE}} !important;',
						],
					],
					'gradient_angle' => [
						'selectors' => [
							'{{WRAPPER}} .blog-grid.blog-style-masonry .post-item:not(.sticky) .post-content-wrapper:hover .description' => 'background-color: transparent; background-image: linear-gradient({{SIZE}}{{UNIT}}, {{color.VALUE}} {{color_stop.SIZE}}{{color_stop.UNIT}}, {{color_b.VALUE}} {{color_b_stop.SIZE}}{{color_b_stop.UNIT}}) !important;',
						],
					],
				]
		...
		$control->add_group_control(
			...
			[
				...
				'label' => __('Border', 'thegem'),
				'selector' => '{{WRAPPER}} .blog-grid .post-item:not(.sticky) .post-content-wrapper:hover .description',
				'fields_options' => [
					'color' => [
						'default' => thegem_get_option('box_border_color'),
						'selectors' => [
							'{{WRAPPER}} .blog-grid.blog-style-masonry .post-item:not(.sticky) .post-content-wrapper:hover .description' => 'border-color: {{VALUE}} !important;',
						],
					],
					'width' => [
						'default' => [
						...
						'selectors' => [
							'{{WRAPPER}} .blog-grid.blog-style-masonry .post-item:not(.sticky) .post-content-wrapper:hover .description' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
						],
					],
				],
			]
		...
		$control->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .blog-grid.blog-style-masonry .post-item:not(.sticky) .post-title' => 'margin-top: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$control->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .blog-grid.blog-style-masonry .post-item:not(.sticky) .post-title' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$control->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .blog-grid.blog-style-masonry .post-item .summary' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
			]
		);
	...
	protected function sticky_post_containers_styles( $control ) {
		...
		$control->add_group_control(
			...
			[
				...
				'label' => __('Background Type', 'thegem'),
				'types' => ['classic', 'gradient'],
				'selector' => '{{WRAPPER}} .blog-grid .post-item.sticky .post-image',
			]
		);
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => true,
				'selectors' => [
					'{{WRAPPER}} .blog-grid .post-item.sticky .post-image' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => true,
				'selectors' => [
					'{{WRAPPER}} .blog-grid .post-item.sticky .post-image' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$control->add_group_control(
			...
			[
				...
				'fields_options' => [
					...
					'color' => [
						'selectors' => [
							'{{WRAPPER}} .blog-grid.blog-style-masonry .post-item.sticky .description' => 'background: {{VALUE}} !important;',
						],
					],
					'gradient_angle' => [
						'selectors' => [
							'{{WRAPPER}} .blog-grid.blog-style-masonry .post-item.sticky .description' => 'background-color: transparent; background-image: linear-gradient({{SIZE}}{{UNIT}}, {{color.VALUE}} {{color_stop.SIZE}}{{color_stop.UNIT}}, {{color_b.VALUE}} {{color_b_stop.SIZE}}{{color_b_stop.UNIT}}) !important;',
						],
					],
				],
				'condition' => [
		...
		$control->add_group_control(
			...
			[
				...
				'fields_options' => [
					...
					'color' => [
						'selectors' => [
							'{{WRAPPER}} .blog-grid.blog-style-justified .post-item.sticky .post-content-wrapper' => 'background: {{VALUE}} !important;',
						],
					],
					'gradient_angle' => [
						'selectors' => [
							'{{WRAPPER}} .blog-grid.blog-style-justified .post-item.sticky .post-content-wrapper' => 'background-color: transparent; background-image: linear-gradient({{SIZE}}{{UNIT}}, {{color.VALUE}} {{color_stop.SIZE}}{{color_stop.UNIT}}, {{color_b.VALUE}} {{color_b_stop.SIZE}}{{color_b_stop.UNIT}}) !important;',
						],
					],
				],
				'condition' => [
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => true,
				'selectors' => [
					'{{WRAPPER}} .blog-grid.blog-style-masonry .post-item.sticky .description' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'condition' => [
					'layout' => 'masonry',
				],
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => true,
				'selectors' => [
					'{{WRAPPER}} .blog-grid.blog-style-justified .post-item.sticky .post-content-wrapper' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'condition' => [
					'layout' => 'justified',
				],
		...
		$control->add_group_control(
			...
			[
				...
				'label' => __('Border', 'thegem'),
				'selector' => '{{WRAPPER}} .blog-grid .post-item.sticky .description',
				'fields_options' => [
					'color' => [
						'default' => thegem_get_option('box_border_color'),
						'selectors' => [
							'{{WRAPPER}} .blog-grid.blog-style-masonry .post-item.sticky .description' => 'border-color: {{VALUE}} !important;',
						],
					],
				],
				'condition' => [
		...
		$control->add_group_control(
			...
			[
				...
				'label' => __('Border', 'thegem'),
				'selector' => '{{WRAPPER}} .blog-grid.blog-style-justified .post-item.sticky .post-content-wrapper',
				'fields_options' => [
					'color' => [
						'default' => thegem_get_option('box_border_color'),
						'selectors' => [
							'{{WRAPPER}} .blog-grid.blog-style-justified .post-item.sticky .post-content-wrapper' => 'border-color: {{VALUE}} !important;',
						],
					],
					'width' => [
						'default' => [
						...
						'selectors' => [
							'{{WRAPPER}} .blog-grid.blog-style-justified .post-item.sticky .post-content-wrapper' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
						],
					],
				],
				'condition' => [
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => true,
				'selectors' => [
					'{{WRAPPER}} .blog-grid.blog-style-masonry .post-item.sticky .description' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'condition' => [
					'layout' => 'masonry',
				],
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => true,
				'selectors' => [
					'{{WRAPPER}} .blog-grid.blog-style-justified .post-item.sticky .post-content-wrapper' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'condition' => [
					'layout' => 'justified',
				],
		...
		$control->add_group_control(
			...
			[
				...
				'label' => __('Shadow', 'thegem'),
				'selector' => '{{WRAPPER}} .blog-grid.blog-style-masonry .post-item.sticky .description',
				'condition' => [
					'layout' => 'masonry',
				],
			]
	...
	protected function sticky_post_captions_styles( $control ) {
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .blog-grid .post-item.sticky .entry-title span.light, {{WRAPPER}} .blog-grid .post-item.sticky .entry-title span.light a',
				'condition' => [
					'show_title' => 'yes',
				],
			]
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .blog-grid .post-item.sticky .entry-title span.light, {{WRAPPER}} .blog-grid .post-item.sticky .entry-title span.light a' => 'color: {{VALUE}};',
				],
				'condition' => [
					'show_title' => 'yes',
				],
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .blog-grid .post-item.sticky .post-content-wrapper:hover .entry-title span.light, {{WRAPPER}} .blog-grid .post-item.sticky .post-content-wrapper:hover .entry-title span.light a',
				'condition' => [
					'show_title' => 'yes',
				],
			]
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .blog-grid .post-item.sticky .post-content-wrapper:hover .entry-title span.light, {{WRAPPER}} .blog-grid .post-item.sticky .post-content-wrapper:hover .entry-title span.light a' => 'color: {{VALUE}};',
				],
				'condition' => [
					'show_title' => 'yes',
				],
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .blog-grid .post-item.sticky .summary',
				'condition' => [
					'show_description' => 'yes',
				],
			]
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .blog-grid .post-item.sticky .summary' => 'color: {{VALUE}} !important;',
				],
				'condition' => [
					'show_description' => 'yes',
				],
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .blog-grid .post-item.sticky .post-content-wrapper:hover .summary',
				'condition' => [
					'show_description' => 'yes',
				],
			]
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .blog-grid .post-item.sticky .post-content-wrapper:hover .summary' => 'color: {{VALUE}} !important;',
				],
				'condition' => [
					'show_description' => 'yes',
				],
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .blog-grid .post-item.sticky .entry-title-date, {{WRAPPER}} .blog-grid .post-item.sticky .post-date , {{WRAPPER}} .blog-grid .post-item.sticky .gem-news-item-date',
				'condition' => [
					'show_date' => 'yes',
				],
			]
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .blog-grid .post-item.sticky .entry-title-date, {{WRAPPER}} .blog-grid .post-item.sticky .post-date , {{WRAPPER}} .blog-grid .post-item.sticky .gem-news-item-date' => 'color: {{VALUE}} !important;',
				],
				'condition' => [
					'show_date' => 'yes',
				],
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .blog-grid .post-item.sticky .post-content-wrapper:hover .entry-title-date, {{WRAPPER}} .blog-grid .post-item.sticky .post-content-wrapper:hover .post-date, {{WRAPPER}} .blog-grid .post-item.sticky .post-content-wrapper:hover .gem-news-item-date',
				'condition' => [
					'show_date' => 'yes',
				],
			]
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .blog-grid .post-item.sticky .post-content-wrapper:hover .entry-title-date, {{WRAPPER}} .blog-grid .post-item.sticky .post-content-wrapper:hover .post-date, {{WRAPPER}} .blog-grid .post-item.sticky .post-content-wrapper:hover .gem-news-item-date' => 'color: {{VALUE}} !important;',
				],
				'condition' => [
					'show_date' => 'yes',
				],
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .blog-grid .post-item.sticky .post-meta-author',
				'condition' => [
					'show_author' => 'yes',
				],
			]
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .blog-grid .post-item.sticky .post-meta-author' => 'color: {{VALUE}} !important;',
				],
				'condition' => [
					'show_author' => 'yes',
				],
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .blog-grid .post-item.sticky .post-content-wrapper:hover .post-meta-author',
				'condition' => [
					'show_author' => 'yes',
				],
			]
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .blog-grid .post-item.sticky .post-content-wrapper:hover .post-meta-author' => 'color: {{VALUE}} !important;',
				],
				'condition' => [
					'show_author' => 'yes',
				],
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .blog-grid .post-item.sticky .sep' => 'border-color: {{VALUE}} !important;',
				],
			]
		);
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .blog-grid .post-item.sticky .post-content-wrapper:hover .sep' => 'border-color: {{VALUE}} !important;',
				],
			]
		);
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .blog-grid .post-item.sticky .zilla-likes-count',
				'condition' => [
					'show_likes' => 'yes',
				],
			]
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .blog-grid .post-item.sticky .zilla-likes::before' => 'color: {{VALUE}} !important;',
					'{{WRAPPER}} .blog-grid .post-item.sticky .post-meta-likes i' => 'color: {{VALUE}} !important;',
					'{{WRAPPER}} .blog-grid .post-item.sticky .post-meta-likes svg' => 'fill: {{VALUE}} !important;',
				],
				'condition' => [
					'show_likes' => 'yes',
				],
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .blog-grid .post-item.sticky .comments-link .elementor-icon i' => 'color: {{VALUE}} !important;',
				],
				'condition' => [
					'show_comments' => 'yes',
				],
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .blog-grid .post-item.sticky .comments-link a',
				'condition' => [
					'show_comments' => 'yes',
				],
			]
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .blog-grid .post-item.sticky .comments-link a' => 'color: {{VALUE}};',
				],
				'condition' => [
					'image_icon_show' => 'yes',
				],
		...
		if ( 'yes' === ( $settings['show_pagination'] ) ) : ?>
			...
			<?php if ( $settings['pagination_type'] == 'numbers' ) : ?>
				...
				<div class="blog-grid-pagination" data-page="<?php echo esc_attr( $paged ); ?>" data-next-page="<?php echo esc_attr( $next_page ); ?>">
					<?php if ( $settings['pagination_type'] == 'numbers' ): ?>
						<?php $this->thegem_bloggrid_pagination( $news_grid_loop ); ?>
					<?php endif; ?>
				</div>
			<?php endif; ?>

			<?php if( $settings['pagination_type'] == 'load-more-button' && $news_grid_loop->max_num_pages > $paged ): ?>
				<div class="preloader"><div class="preloader-spin"></div></div>
			...
			<?php if( $settings['pagination_type'] == 'infinite-scroll' && $news_grid_loop->max_num_pages > $paged ): ?>
