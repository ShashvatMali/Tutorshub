...
<div class="gem-gallery-item">
	<div class="gem-gallery-item-image">
		<a href="<?php echo($item['slide_image']['id'] ? $preview_image_url[0] : Utils::get_placeholder_image_src()); ?>"
			data-full-image-url="<?php echo($item['slide_image']['id'] ? $full_image_url : Utils::get_placeholder_image_src()); ?>"
			...
			<?php if (!empty($icon['value'])) {
				Icons_Manager::render_icon($icon, ['aria-hidden' => 'true', 'class' => 'photo-icon']);
			} ?>
