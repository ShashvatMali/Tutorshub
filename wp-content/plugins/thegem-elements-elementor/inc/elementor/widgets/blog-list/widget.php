...
class TheGem_Bloglist extends Widget_Base {
	...
	public function __construct( $data = [], $args = null ) {
		...
		if (isset($data['settings']) && (empty($_REQUEST['action']) || !in_array($_REQUEST['action'], array('thegem_importer_process', 'thegem_templates_new', 'thegem_blocks_import')))) {
			...
			if (isset($data['settings']['select_blog_cat'])) {
				$data['settings']['categories'] = $data['settings']['select_blog_cat'];
				unset($data['settings']['select_blog_cat']);
			}
	...
	protected function general_styles( $control ) {
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .bloglist .post-item:not(.sticky) .item-post-container',
				'condition' => [
		...
		$control->add_group_control(
			...
			[
				...
				'label' => __('Common Shadow', 'thegem'),
				'selector' => '{{WRAPPER}} .bloglist .post-item:not(.sticky)',
				'condition' => [
	...
	protected function image_styles( $control ) {
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => true,
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item .post-img a img,
					{{WRAPPER}} .bloglist .post-item .post-img a,
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .bloglist .post-item:not(.sticky) .post-img a img',
				'fields_options' => [
					'color' => [
						'default' => thegem_get_option('box_border_color'),
					],
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .bloglist .post-item:not(.sticky) .post-img a',
				'condition' => [
					'thegem_elementor_preset!' => [ 'compact-tiny-1', 'compact-tiny-2',  'compact-tiny-3', 'classic-tiny' ]
				],
			]
		...
		$control->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item:not(.sticky) .post-img' => 'opacity: calc({{SIZE}}/100);',
				],
			]
		);
		...
		$control->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item:not(.sticky) .post-img img' => 'mix-blend-mode: {{VALUE}}',
				],
				'separator' => 'none',
			]
		);
			...
			[
				...
				'fields_options' => [
					...
					'color' => [
						...
						'selectors' => [
							'{{WRAPPER}} .bloglist .post-item .post-img a:hover::before' => 'background: {{VALUE}} !important;',
						],
					],
					'gradient_angle' => [
						'selectors' => [
							'{{WRAPPER}} .bloglist .post-item .post-img a:hover::before' => 'background-color: transparent; background-image: linear-gradient({{SIZE}}{{UNIT}}, {{color.VALUE}} {{color_stop.SIZE}}{{color_stop.UNIT}}, {{color_b.VALUE}} {{color_b_stop.SIZE}}{{color_b_stop.UNIT}}) !important;',
						],
					],
				]
			]
		...
		$control->add_group_control(
			...
			[
				...
				'label' => __('CSS Filters', 'thegem'),
				'selector' => '{{WRAPPER}} .bloglist .post-item:not(.sticky) .post-img a:hover img',
			]
		);
		...
		$control->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item:not(.sticky) .post-img:hover' => 'mix-blend-mode: {{VALUE}}',
				],
				'separator' => 'none',
			]
		);
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item:not(.sticky) .post-img a:after' => 'color: {{VALUE}};',
				],
				'condition' => [
					'image_icon_show' => 'yes',
				],
		...
		$control->add_responsive_control(
			...
			[
				...
				'default' => '#3c3950',
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item:not(.sticky) .post-img a:after' => 'background-color: {{VALUE}};',
				],
				'condition' => [
					'image_icon_show' => 'yes',
				],
		...
		$control->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item:not(.sticky) .post-img a:after' => 'font-size: {{SIZE}}{{UNIT}};',
				],
				'condition' => [
					'image_icon_show' => 'yes',
				],
		...
		$control->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item:not(.sticky) .post-img a:after' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}}; line-height: {{SIZE}}{{UNIT}}; margin-top: calc(-{{SIZE}}{{UNIT}} / 2); margin-left: calc(-{{SIZE}}{{UNIT}} / 2)',
				],
				'condition' => [
					'image_icon_show' => 'yes',
				],
		...
		$control->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item:not(.sticky) .post-img a:after' => 'transform: rotate({{SIZE}}deg); -webkit-transform: rotate({{SIZE}}deg);',
				],
				'condition' => [
					'image_icon_show' => 'yes',
				],
	...
	protected function image_container_styles( $control ) {
		...
		$control->add_group_control(
			...
			[
				...
				'types' => ['classic', 'gradient'],
				'selector' => '{{WRAPPER}} .bloglist .post-item:not(.sticky) .post-img',
			]
		);
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => true,
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item:not(.sticky) .post-img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .blog-style-default .post-item:not(.sticky) .item-post-container' => 'border-top-left-radius: {{TOP}}{{UNIT}};border-top-right-radius: {{RIGHT}}{{UNIT}};',
				],
			]
		);
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => true,
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item:not(.sticky) .post-img' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'condition' => [
	...
	protected function image_container_styles_styled( $control ) {
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => true,
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item:not(.sticky)' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => true,
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item:not(.sticky) .post-img a img' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'condition' => [
	...
	protected function caption_styles( $control ) {
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .bloglist .post-item:not(.sticky) .post-title *',
				'condition' => [
					'show_title' => 'yes',
				],
			]
		...
		$control->add_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item:not(.sticky) .post-title *' => 'color: {{VALUE}};',
				],
				'condition' => [
					'show_title' => 'yes',
				],
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .bloglist .post-item:not(.sticky) .caption-container:hover .post-title *',
				'condition' => [
					'show_title' => 'yes',
				],
			]
		...
		$control->add_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item:not(.sticky) .caption-container:hover .post-title *' => 'color: {{VALUE}};',
				],
				'condition' => [
					'show_title' => 'yes',
				],
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .bloglist .post-item:not(.sticky) .summary',
				'condition' => [
					'show_description' => 'yes',
				],
			]
		...
		$control->add_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item:not(.sticky) .summary' => 'color: {{VALUE}} !important;',
				],
				'condition' => [
					'show_description' => 'yes',
				],
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .bloglist .post-item:not(.sticky) .caption-container:hover .summary',
				'condition' => [
					'show_description' => 'yes',
				],
			]
		...
		$control->add_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item:not(.sticky) .caption-container:hover .summary' => 'color: {{VALUE}} !important;',
				],
				'condition' => [
					'show_description' => 'yes',
				],
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .bloglist .post-item:not(.sticky) .entry-title-date, {{WRAPPER}} .bloglist .post-item:not(.sticky) .post-date , {{WRAPPER}} .bloglist .post-item:not(.sticky) .gem-news-item-date',
				'condition' => [
					'show_date' => 'yes',
				],
			]
		...
		$control->add_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item:not(.sticky) .entry-title-date, {{WRAPPER}} .bloglist .post-item:not(.sticky) .post-date , {{WRAPPER}} .bloglist .post-item:not(.sticky) .gem-news-item-date' => 'color: {{VALUE}} !important;',
				],
				'condition' => [
					'show_date' => 'yes',
				],
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .bloglist .post-item:not(.sticky) .caption-container:hover .entry-title-date, {{WRAPPER}} .bloglist .post-item:not(.sticky) .caption-container:hover .post-date, {{WRAPPER}} .bloglist .post-item:not(.sticky) .caption-container:hover .gem-news-item-date',
				'condition' => [
					'show_date' => 'yes',
				],
			]
		...
		$control->add_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item:not(.sticky) .caption-container:hover .entry-title-date, {{WRAPPER}} .bloglist .post-item:not(.sticky) .caption-container:hover .post-date, {{WRAPPER}} .bloglist .post-item:not(.sticky) .caption-container:hover .gem-news-item-date' => 'color: {{VALUE}} !important;',
				],
				'condition' => [
					'show_date' => 'yes',
				],
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .bloglist .post-item:not(.sticky) .post-time',
				'condition' => [
					'thegem_elementor_preset' => [ 'styled_list1', 'styled_list2' ],
					'show_date' => 'yes',
				],
		...
		$control->add_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item:not(.sticky) .post-time' => 'color: {{VALUE}} !important;',
				],
				'condition' => [
					'thegem_elementor_preset' => [ 'styled_list1', 'styled_list2' ],
					'show_date' => 'yes',
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .bloglist .post-item:not(.sticky) .caption-container:hover .post-time',
				'condition' => [
					'thegem_elementor_preset' => [ 'styled_list1', 'styled_list2' ],
					'show_date' => 'yes',
				],
		...
		$control->add_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item:not(.sticky) .caption-container:hover .post-time' => 'color: {{VALUE}} !important;',
				],
				'condition' => [
					'thegem_elementor_preset' => [ 'styled_list1', 'styled_list2' ],
					'show_date' => 'yes',
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .bloglist .post-item:not(.sticky) .post-meta-categories a',
			]
		);
		...
		$control->add_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item:not(.sticky) .post-meta-categories a' => 'color: {{VALUE}} !important;',
				],
			]
		);
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .bloglist .post-item:not(.sticky) .caption-container:hover .post-meta-categories a',
			]
		);
		...
		$control->add_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item:not(.sticky) .caption-container:hover .post-meta-categories a' => 'color: {{VALUE}} !important;',
				],
			]
		);
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .bloglist .post-item:not(.sticky) .post-meta-author',
			]
		);
		...
		$control->add_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item:not(.sticky) .post-meta-author' => 'color: {{VALUE}} !important;',
				],
			]
		);
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .bloglist .post-item:not(.sticky) .caption-container:hover .post-meta-author',
			]
		);
		...
		$control->add_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item:not(.sticky) .caption-container:hover .post-meta-author' => 'color: {{VALUE}} !important;',
				],
			]
		);
		...
		$control->add_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item:not(.sticky) .sep' => 'border-color: {{VALUE}} !important;',
				],
			]
		);
		...
		$control->add_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item:not(.sticky) .caption-container:hover .sep' => 'border-color: {{VALUE}} !important;',
				],
			]
		);
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item:not(.sticky) .zilla-likes::before' => 'color: {{VALUE}} !important;',
					'{{WRAPPER}} .bloglist .post-item:not(.sticky) .post-meta-likes i' => 'color: {{VALUE}} !important;',
					'{{WRAPPER}} .bloglist .post-item:not(.sticky) .post-meta-likes svg' => 'fill: {{VALUE}} !important;',
				],
			]
		);
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .bloglist .post-item:not(.sticky) .zilla-likes-count',
			]
		);
		...
		$control->add_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item:not(.sticky) .zilla-likes-count' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$control->add_responsive_control(
			...
			[
				...
				'default' => '#393d50',
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item:not(.sticky) .zilla-likes::before:hover' => 'color: {{VALUE}} !important;',
					'{{WRAPPER}} .bloglist .post-item:not(.sticky) .post-meta-likes i:hover' => 'color: {{VALUE}} !important;',
					'{{WRAPPER}} .bloglist .post-item:not(.sticky) .post-meta-likes svg:hover' => 'fill: {{VALUE}} !important;',
				],
			]
		);
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .bloglist .post-item:not(.sticky) .zilla-likes-count:hover',
			]
		);
		...
		$control->add_control(
			...
			[
				...
				'default' => '#393d50',
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item:not(.sticky) .zilla-likes-count:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$control->add_responsive_control(
			...
			[
				...
				'default' => '#99a9b5',
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item:not(.sticky) .comments-link .elementor-icon i' => 'color: {{VALUE}} !important;',
				],
			]
		);
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .bloglist .post-item:not(.sticky) .comments-link a',
			]
		);
		...
		$control->add_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item:not(.sticky) .comments-link a' => 'color: {{VALUE}};',
				],
				'condition' => [
					'image_icon_show' => 'yes',
				],
		...
		$control->add_responsive_control(
			...
			[
				...
				'default' => '#00bcd4',
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item:not(.sticky) .comments-link .elementor-icon i:hover' => 'color: {{VALUE}} !important;',
				],
			]
		);
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .bloglist .post-item:not(.sticky) .comments-link a:hover',
			]
		);
		...
		$control->add_control(
			...
			[
				...
				'default' => '#00bcd4',
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item:not(.sticky) .comments-link a:hover' => 'color: {{VALUE}};',
				],
				'condition' => [
					'image_icon_show' => 'yes',
				],
	...
	protected function caption_container_styles( $control ) {
		...
		$control->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item .caption-container .post-title' => 'text-align: {{VALUE}}',
					'{{WRAPPER}} .bloglist .post-item .caption-container .post-text, {{WRAPPER}} .bloglist .post-item .caption-container .post-content, {{WRAPPER}} .bloglist .post-item .caption-container .gem-news_title-excerpt.summary' => 'text-align: {{VALUE}}',
					'{{WRAPPER}} .bloglist .post-item .caption-container .post-footer' => 'text-align: {{VALUE}}',
				],
			]
		);
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => true,
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item:not(.sticky) .caption-container' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .bloglist .post-item:not(.sticky) .item-post-container' => 'border-bottom-left-radius: {{LEFT}}{{UNIT}};border-bottom-right-radius: {{BOTTOM}}{{UNIT}};',
				],
			]
		);
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => true,
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item:not(.sticky) .caption-container' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$control->add_group_control(
			...
			[
				...
				'label' => __('Shadow', 'thegem'),
				'selector' => '{{WRAPPER}} .bloglist .post-item:not(.sticky) .caption-container',
				'condition' => [
		...
		$control->add_group_control(
			...
			[
				...
				'fields_options' => [
					...
					'color' => [
						'selectors' => [
							'{{WRAPPER}} .bloglist .post-item:not(.sticky) .caption-container' => 'background: {{VALUE}} !important;',
							'{{WRAPPER}} .bloglist.blog-style-compact article .gem-compact-item-content:after' => 'box-shadow: 0 5px 15px 15px {{VALUE}} !important;',
							'{{WRAPPER}} .bloglist .post-item:not(.sticky) .wrap-style' => 'fill: {{VALUE}} !important;',
						],
					],
					'gradient_angle' => [
						'selectors' => [
							'{{WRAPPER}} .bloglist .post-item:not(.sticky) .caption-container' => 'background-color: transparent; background-image: linear-gradient({{SIZE}}{{UNIT}}, {{color.VALUE}} {{color_stop.SIZE}}{{color_stop.UNIT}}, {{color_b.VALUE}} {{color_b_stop.SIZE}}{{color_b_stop.UNIT}}) !important;',
						],
					],
				]
			...
			[
				...
				'fields_options' => [
					'color' => [
						'default' => thegem_get_option('box_border_color'),
						'selectors' => [
							'{{WRAPPER}} .bloglist .post-item:not(.sticky) .caption-container' => 'border-color: {{VALUE}} !important;',
							'{{WRAPPER}} .bloglist .post-item:not(.sticky) .wrap-style' => 'stroke: {{VALUE}} !important;',
						],
					],
					'width' => [
						'default' => [
						...
						'selectors' => [
							'{{WRAPPER}} .bloglist .post-item:not(.sticky) .caption-container' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
							'{{WRAPPER}} .bloglist .post-item:not(.sticky) .wrap-style' => 'stroke-width: {{TOP}}{{UNIT}} !important;',
						],
					],
				],
			]
		...
		$control->add_group_control(
			...
			[
				...
				'fields_options' => [
					...
					'color' => [
						'selectors' => [
							'{{WRAPPER}} .bloglist .post-item:not(.sticky) .caption-container:hover' => 'background: {{VALUE}} !important;',
							'{{WRAPPER}} .bloglist .post-item:not(.sticky) .caption-container:hover .wrap-style' => 'fill: {{VALUE}} !important;',
						],
					],
					'gradient_angle' => [
						'selectors' => [
							'{{WRAPPER}} .bloglist .post-item:not(.sticky) .caption-container:hover' => 'background-color: transparent; background-image: linear-gradient({{SIZE}}{{UNIT}}, {{color.VALUE}} {{color_stop.SIZE}}{{color_stop.UNIT}}, {{color_b.VALUE}} {{color_b_stop.SIZE}}{{color_b_stop.UNIT}}) !important;',
						],
					],
				]
			...
			[
				...
				'fields_options' => [
					'color' => [
						'default' => thegem_get_option('box_border_color'),
						'selectors' => [
							'{{WRAPPER}} .bloglist .post-item:not(.sticky) .caption-container:hover' => 'border-color: {{VALUE}} !important;',
							'{{WRAPPER}} .bloglist .post-item:not(.sticky) .caption-container:hover .wrap-style' => 'stroke: {{VALUE}} !important;',
						],
					],
					'width' => [
						'default' => [
						...
						'selectors' => [
							'{{WRAPPER}} .bloglist .post-item:not(.sticky) .caption-container:hover' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
							'{{WRAPPER}} .bloglist .post-item:not(.sticky) .caption-container:hover .wrap-style' => 'stroke-width: {{TOP}}{{UNIT}} !important;',
						],
					],
				],
			]
		...
		$control->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bloglist:not(.blog-style-compact-2) .post-item:not(.sticky) .post-title' => 'margin-top: calc({{SIZE}}{{UNIT}} - 50px);',
					'{{WRAPPER}} .bloglist.blog-style-compact-2 .post-item:not(.sticky) .post-title' => 'margin-top: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$control->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bloglist:not(.blog-style-compact-2) .post-item:not(.sticky) .post-title' => 'margin-bottom: calc({{SIZE}}{{UNIT}} - 20px);',
					'{{WRAPPER}} .bloglist.blog-style-compact-2 .post-item:not(.sticky) .post-title' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$control->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item:not(.sticky) .summary' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
			]
		);
	...
	protected function sticky_post_containers_styles( $control ) {
		...
		$control->add_group_control(
			...
			[
				...
				'label' => __('Background Type', 'thegem'),
				'types' => ['classic', 'gradient'],
				'selector' => '{{WRAPPER}} .bloglist.blog-style-default .post-item.sticky',
				'condition' => [
					'thegem_elementor_preset' => 'default',
				],
			]
		...
		$control->add_group_control(
			...
			[
				...
				'label' => __('Border', 'thegem'),
				'selector' => '{{WRAPPER}} .bloglist.blog-style-default .post-item.sticky, {{WRAPPER}} .bloglist.blog-style-default .post-item.sticky:after',
				'fields_options' => [
					'color' => [
						'default' => thegem_get_option('box_border_color'),
						'selectors' => [
							'{{WRAPPER}} .bloglist.blog-style-default .post-item.sticky' => 'border-color: {{VALUE}} !important;',
							'{{WRAPPER}} .bloglist.blog-style-default .post-item.sticky:after' => 'border-color: {{VALUE}} !important;',
						],
					],
					'width' => [
						'default' => [
						...
						'selectors' => [
							'{{WRAPPER}} .bloglist.blog-style-default .post-item.sticky' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
							'{{WRAPPER}} .bloglist.blog-style-default .post-item.sticky:after' => 'border-width: 0{{UNIT}} 0{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;bottom: calc(-75px - {{BOTTOM}}{{UNIT}});left: -{{BOTTOM}}{{UNIT}};',
						],
					],
				],
				'condition' => [
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => true,
				'selectors' => [
					'{{WRAPPER}} .bloglist.blog-style-default .post-item.sticky' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'condition' => [
					'thegem_elementor_preset' => 'default',
				],
		...
		$control->add_group_control(
			...
			[
				...
				'label' => __( 'Background Type', 'thegem' ),
				'types' => [ 'classic', 'gradient' ],
				'selector' => '{{WRAPPER}} .bloglist .post-item.sticky',
				'condition' => [
					'thegem_elementor_preset' => 'styled_list1',
				],
			]
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => true,
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item.sticky .post-img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .blog-style-default .post-item.sticky .item-post-container' => 'border-top-left-radius: {{TOP}}{{UNIT}};border-top-right-radius: {{RIGHT}}{{UNIT}};',
				],
				'condition' => [
					'thegem_elementor_preset!' => 'styled_list1',
				],
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => true,
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item.sticky' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'condition' => [
					'thegem_elementor_preset' => 'styled_list1',
				],
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .bloglist .post-item.sticky .post-img',
				'condition' => [
					'thegem_elementor_preset!' => 'styled_list1',
				],
			]
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => true,
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item.sticky .post-img' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'condition' => [
					'thegem_elementor_preset' => [ 'default', 'compact', 'styled_list2' ],
				],
		...
		$control->add_group_control(
			...
			[
				...
				'fields_options' => [
					...
					'color' => [
						'selectors' => [
							'{{WRAPPER}} .bloglist .post-item.sticky .caption-container' => 'background: {{VALUE}} !important;',
							'{{WRAPPER}} .bloglist .post-item.sticky .wrap-style' => 'fill: {{VALUE}} !important;',
						],
					],
					'gradient_angle' => [
						'selectors' => [
							'{{WRAPPER}} .bloglist .post-item.sticky .caption-container' => 'background-color: transparent; background-image: linear-gradient({{SIZE}}{{UNIT}}, {{color.VALUE}} {{color_stop.SIZE}}{{color_stop.UNIT}}, {{color_b.VALUE}} {{color_b_stop.SIZE}}{{color_b_stop.UNIT}}) !important;',
						],
					],
				]
			]
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => true,
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item.sticky .caption-container' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$control->add_group_control(
			...
			[
				...
				'label' => __('Border', 'thegem'),
				'selector' => '{{WRAPPER}} .bloglist .post-item.sticky .caption-container',
				'fields_options' => [
					'color' => [
						'default' => thegem_get_option('box_border_color'),
						'selectors' => [
							'{{WRAPPER}} .bloglist .post-item.sticky .caption-container' => 'border-color: {{VALUE}} !important;',
							'{{WRAPPER}} .bloglist .post-item.sticky .wrap-style' => 'stroke: {{VALUE}} !important;',
						],
					],
				]
			]
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => true,
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item.sticky .caption-container' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
	...
	protected function sticky_post_captions_styles( $control ) {
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .bloglist .post-item.sticky .entry-title span.light, {{WRAPPER}} .bloglist .post-item.sticky .entry-title span.light a',
				'condition' => [
					'show_title' => 'yes',
				],
			]
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item.sticky .entry-title span.light, {{WRAPPER}} .bloglist .post-item.sticky .entry-title span.light a' => 'color: {{VALUE}} !important;',
				],
				'condition' => [
					'show_title' => 'yes',
				],
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .bloglist .post-item.sticky .caption-container:hover .entry-title span.light, {{WRAPPER}} .bloglist .post-item.sticky .caption-container:hover .entry-title span.light a',
				'condition' => [
					'show_title' => 'yes',
				],
			]
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item.sticky .caption-container:hover .entry-title span.light, {{WRAPPER}} .bloglist .post-item.sticky .caption-container:hover .entry-title span.light a ' => 'color: {{VALUE}} !important;',
				],
				'condition' => [
					'show_title' => 'yes',
				],
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .bloglist .post-item.sticky .summary',
				'condition' => [
					'show_description' => 'yes',
				],
			]
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item.sticky .summary' => 'color: {{VALUE}} !important;',
				],
				'condition' => [
					'show_description' => 'yes',
				],
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .bloglist .post-item.sticky .caption-container:hover .summary',
				'condition' => [
					'show_description' => 'yes',
				],
			]
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item.sticky .caption-container:hover .summary' => 'color: {{VALUE}} !important;',
				],
				'condition' => [
					'show_description' => 'yes',
				],
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .bloglist .post-item.sticky .entry-title-date, {{WRAPPER}} .bloglist .post-item.sticky .post-date , {{WRAPPER}} .bloglist .post-item.sticky .gem-news-item-date',
				'condition' => [
					'show_date' => 'yes',
				],
			]
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item.sticky .entry-title-date, {{WRAPPER}} .bloglist .post-item.sticky .post-date , {{WRAPPER}} .bloglist .post-item.sticky .gem-news-item-date' => 'color: {{VALUE}} !important;',
				],
				'condition' => [
					'show_date' => 'yes',
				],
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .bloglist .post-item.sticky .caption-container:hover .entry-title-date, {{WRAPPER}} .bloglist .post-item.sticky .caption-container:hover .post-date, {{WRAPPER}} .bloglist .post-item.sticky .caption-container:hover .gem-news-item-date',
				'condition' => [
					'show_date' => 'yes',
				],
			]
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item.sticky .caption-container:hover .entry-title-date, {{WRAPPER}} .bloglist .post-item.sticky .caption-container:hover .post-date, {{WRAPPER}} .bloglist .post-item.sticky .caption-container:hover .gem-news-item-date' => 'color: {{VALUE}} !important;',
				],
				'condition' => [
					'show_date' => 'yes',
				],
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .bloglist .post-item.sticky .post-time',
				'condition' => [
					'thegem_elementor_preset' => [ 'styled_list1', 'styled_list2' ],
					'show_date' => 'yes',
				],
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item.sticky .post-time' => 'color: {{VALUE}} !important;',
				],
				'condition' => [
					'thegem_elementor_preset' => [ 'styled_list1', 'styled_list2' ],
					'show_date' => 'yes',
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .bloglist .post-item.sticky .caption-container:hover .post-time',
				'condition' => [
					'thegem_elementor_preset' => [ 'styled_list1', 'styled_list2' ],
					'show_date' => 'yes',
				],
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item.sticky .caption-container:hover .post-time' => 'color: {{VALUE}} !important;',
				],
				'condition' => [
					'thegem_elementor_preset' => [ 'styled_list1', 'styled_list2' ],
					'show_date' => 'yes',
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .bloglist .post-item.sticky .post-meta-categories a',
				'condition' => [
					'thegem_elementor_preset!' => [ 'compact', 'compact-2' ],
					'show_categories' => 'yes',
				],
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item.sticky .post-meta-categories a' => 'color: {{VALUE}} !important;',
				],
				'condition' => [
					'thegem_elementor_preset!' => [ 'compact', 'compact-2' ],
					'show_categories' => 'yes',
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .bloglist .post-item.sticky .caption-container:hover .post-meta-categories a',
				'condition' => [
					'thegem_elementor_preset!' => [ 'compact', 'compact-2' ],
					'show_categories' => 'yes',
				],
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item.sticky .caption-container:hover .post-meta-categories a' => 'color: {{VALUE}} !important;',
				],
				'condition' => [
					'thegem_elementor_preset!' => [ 'compact', 'compact-2' ],
					'show_categories' => 'yes',
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .bloglist .post-item.sticky .post-meta-author',
				'condition' => [
					'thegem_elementor_preset!' => [ 'compact-2' ],
					'show_author' => 'yes',
				],
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item.sticky .post-meta-author' => 'color: {{VALUE}} !important;',
				],
				'condition' => [
					'thegem_elementor_preset!' => [ 'compact-2' ],
					'show_author' => 'yes',
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .bloglist .post-item.sticky .caption-container:hover .post-meta-author',
				'condition' => [
					'thegem_elementor_preset!' => [ 'compact-2' ],
					'show_author' => 'yes',
				],
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item.sticky .caption-container:hover .post-meta-author' => 'color: {{VALUE}} !important;',
				],
				'condition' => [
					'thegem_elementor_preset!' => [ 'compact-2' ],
					'show_author' => 'yes',
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item.sticky .sep' => 'border-color: {{VALUE}} !important;',
				],
				'condition' => [
					'thegem_elementor_preset!' => [ 'compact-2' ],
				],
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item.sticky .caption-container:hover .sep' => 'border-color: {{VALUE}} !important;',
				],
				'condition' => [
					'thegem_elementor_preset!' => [ 'compact-2' ],
				],
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .bloglist .post-item.sticky .zilla-likes-count',
				'condition' => [
					'show_likes' => 'yes',
				],
			]
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item.sticky .zilla-likes::before' => 'color: {{VALUE}} !important;',
					'{{WRAPPER}} .bloglist .post-item.sticky .post-meta-likes i' => 'color: {{VALUE}} !important;',
					'{{WRAPPER}} .bloglist .post-item.sticky .post-meta-likes svg' => 'fill: {{VALUE}} !important;',
				],
				'condition' => [
					'show_likes' => 'yes',
				],
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .bloglist .post-item.sticky .comments-link a',
				'condition' => [
					'show_comments' => 'yes',
				],
			]
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .bloglist .post-item.sticky .comments-link a::before' => 'color: {{VALUE}} !important;',
				],
				'condition' => [
					'show_comments' => 'yes',
				],
	...
	public function render() {
		...
		if (!in_array($settings['thegem_elementor_preset'], ['compact-tiny-1', 'compact-tiny-2',  'compact-tiny-3', 'classic-tiny' ])) {
			...
			$is_compact = true;
			$settings['pagination_type'] = 'normal';
			$settings['show_pagination'] = $settings['show_pagination_compact'];
		}

		if (!$is_compact || $settings['show_pagination'] == 'yes') {
		...
		$this->add_render_attribute('blog_wrapper', 'class',
			[
				...
				($settings['show_pagination'] == 'yes' ? ' pagination-' . $settings['pagination_type'] : ''),
		...
		$news_grid_loop = get_thegem_extended_blog_posts($post_type, $taxonomy_filter, [], $manual_selection, $exclude, $blog_authors, $paged, $items_per_page, $orderby, $order, $settings['offset'], $settings['ignore_sticky_posts'], false, false, $date_query);
		...
		$this->add_render_attribute( 'blog_wrapper', 'data-pages-count',  $max_page );
		...
		if ($max_page > 1 && $settings['show_pagination'] == 'yes') :
			...
			if ($settings['pagination_type'] == 'infinite-scroll' || $settings['pagination_type'] == 'load-more-button' || $is_compact) {
			...
			<?php if ( $settings['pagination_type'] == 'numbers' ) : ?>
				...
				<div class="bloglist-pagination" data-page="<?php echo esc_attr( $paged ); ?>" data-next-page="<?php echo esc_attr( $next_page ); ?>">
					<?php if ( $settings['pagination_type'] == 'numbers' ): ?>
						<?php $this->thegem_bloglist_pagination( $news_grid_loop ); ?>
					<?php endif; ?>
				</div>
			<?php endif; ?>

			<?php if( $settings['pagination_type'] == 'load-more-button' && $max_page > $paged ): ?>
				<div class="preloader"><div class="preloader-spin"></div></div>
			...
			<?php if( $settings['pagination_type'] == 'infinite-scroll' && $max_page > $paged ): ?>
