 ...
 * @since 1.0.0
 */
class Element_TheGem_Section extends Element_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} > .elementor-container > .elementor-row > .elementor-column > .elementor-widget-wrap' => 'align-content: {{VALUE}}; align-items: {{VALUE}};',
				],
	...
	protected function content_template() {
		...
		<div class="elementor-container elementor-column-gap-{{ settings.gap }}"><div class="elementor-row"></div></div>
		<?php
	}
	...
	public function before_render() {
		...
		?> <?php $this->print_render_attribute_string( '_wrapper' ); ?>>
			...
			?>
			<div class="elementor-container elementor-column-gap-<?php echo esc_attr( $settings['gap'] ); ?>"><div class="elementor-row">
			<?php
	}
