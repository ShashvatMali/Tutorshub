...
namespace TheGem_Elementor\Widgets\TemplateProductDescription;
...
class TheGem_TemplateProductDescription extends Widget_Base {
	...
	public function get_name() {
		return 'thegem-template-product-description';
	}
	...
	public function get_title() {
		return __('Product Short Description', 'thegem');
	}
	...
	public function get_widget_wrapper() {
		return 'thegem-te-product-description';
	}
	...
	public function render() {
		...
		$alignment = !empty($params['alignment']) ? 'description--'.$params['alignment'] : '';
		...
		<div class="<?= esc_attr($params['element_class']); ?>">
            <div class="product-description <?= $text_styled_class ?>">
		        <?= $short_description ?>
            </div>
        </div>
...
if(defined('WC_PLUGIN_FILE')) {
	\Elementor\Plugin::instance()->widgets_manager->register(new TheGem_TemplateProductDescription());
}