...
namespace TheGem_Elementor\Widgets\TemplatePortfolioFeaturedImage;
...
class TheGem_TemplatePortfolioFeaturedImage extends Widget_Base {
	...
	public function get_name() {
		return 'thegem-template-portfolio-featured-image';
	}
	...
	public function get_widget_wrapper() {
		return 'thegem-te-portfolio-featured-image';
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .thegem-te-portfolio-featured-image .portfolio-featured-image img' => 'width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .thegem-te-portfolio-featured-image .portfolio-featured-image img' => 'height: {{SIZE}}{{UNIT}};',
				],
			]
		);
...
\Elementor\Plugin::instance()->widgets_manager->register(new TheGem_TemplatePortfolioFeaturedImage());
