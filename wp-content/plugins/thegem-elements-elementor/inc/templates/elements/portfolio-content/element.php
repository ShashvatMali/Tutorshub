...
namespace TheGem_Elementor\Widgets\TemplatePortfolioContent;
...
/**
 * Elementor widget for Portfolio Content.
 */

#[\AllowDynamicProperties]
class TheGem_TemplatePortfolioContent extends Widget_Base {
	...
	public function get_name() {
		return 'thegem-template-portfolio-content';
	}
	...
	public function get_widget_wrapper() {
		return 'thegem-te-portfolio-content';
	}
	...
	public function get_customize_class($only_parent = false) {
		...
		return ' .'.$this->get_widget_wrapper().' .portfolio-content';
	}
	...
	public function render() {
		...
		if(!empty($return_html)) {
			$return_html = '<div class="'.esc_attr($params['element_class']).'"><div class="portfolio-content '.$params['text_styled'].'">'.$return_html.'</div></div>';
		}
...
\Elementor\Plugin::instance()->widgets_manager->register(new TheGem_TemplatePortfolioContent());
