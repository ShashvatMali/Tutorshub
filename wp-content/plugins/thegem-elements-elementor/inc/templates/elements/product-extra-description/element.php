...
namespace TheGem_Elementor\Widgets\TemplateProductExtraDescription;
...
/**
 * Elementor widget for Product ExtraDescription.
 */

#[\AllowDynamicProperties]
class TheGem_TemplateProductExtraDescription extends Widget_Base {
	...
	public function get_name() {
		return 'thegem-template-product-extra-description';
	}
	...
	public function get_title() {
		return __('Product Extra Description', 'thegem');
	}
	...
	public function get_widget_wrapper() {
		return 'thegem-te-product-extra-description';
	}
	...
	public function get_customize_class($only_parent = false) {
		...
		return ' .'.$this->get_widget_wrapper().' .product-extra-description-title';
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'title',
			[
				'label' => __('Extra Description Title', 'thegem'),
...
if(defined('WC_PLUGIN_FILE')) {
	\Elementor\Plugin::instance()->widgets_manager->register(new TheGem_TemplateProductExtraDescription());
}