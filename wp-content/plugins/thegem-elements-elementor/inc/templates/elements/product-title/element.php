...
namespace TheGem_Elementor\Widgets\TemplateProductTitle;
...
class TheGem_TemplateProductTitle extends Widget_Base {
	...
	public function get_name() {
		return 'thegem-template-product-title';
	}
	...
	public function get_title() {
		return __('Product Title', 'thegem');
	}
	...
	public function get_widget_wrapper() {
		return 'thegem-te-product-title';
	}
	...
	public function render() {
		...
		if (empty($product) || empty($product->get_title())) {
			ob_end_clean();
...
if(defined('WC_PLUGIN_FILE')) {
	\Elementor\Plugin::instance()->widgets_manager->register(new TheGem_TemplateProductTitle());
}