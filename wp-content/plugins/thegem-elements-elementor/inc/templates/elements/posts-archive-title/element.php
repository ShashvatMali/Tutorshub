...
namespace TheGem_Elementor\Widgets\TemplateBlogArchiveTitle;
...
class TheGem_TemplateBlogArchiveTitle extends Widget_Base {
	...
	public function get_name() {
		return 'thegem-template-blog-archive-title';
	}
	...
	public function get_widget_wrapper() {
		return 'thegem-te-blog-archive-title';
	}
	...
	public function get_customize_class($only_parent = false) {
		...
		return ' .'.$this->get_widget_wrapper().' .blog-title';
	}
	...
	public function render() {
		...
		$title = '';
		if(is_search()) {
			$title = thegem_get_option('website_search_page_title') ? thegem_get_option('website_search_page_title') : sprintf(__( 'Search results for: "%s"' ), get_search_query());
		} else {
			$title = $term->name;
		}
...
\Elementor\Plugin::instance()->widgets_manager->register(new TheGem_TemplateBlogArchiveTitle());
