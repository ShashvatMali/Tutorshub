...
namespace TheGem_Elementor\Widgets\TemplateProductArchiveTitle;
...
class TheGem_TemplateProductArchiveTitle extends Widget_Base {
	...
	public function get_name() {
		return 'thegem-template-product-archive-title';
	}
	...
	public function get_title() {
		return __('Archive Title', 'thegem');
	}
	...
	public function get_widget_wrapper() {
		return 'thegem-te-product-archive-title';
	}
	...
	public function get_customize_class($only_parent = false) {
		...
		return ' .'.$this->get_widget_wrapper().' .product-title';
	}
...
if(defined('WC_PLUGIN_FILE')) {
	\Elementor\Plugin::instance()->widgets_manager->register(new TheGem_TemplateProductArchiveTitle());
}