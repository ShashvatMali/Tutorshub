...
namespace TheGem_Elementor\Widgets\TemplatePostContent;
...
/**
 * Elementor widget for Post Content.
 */

#[\AllowDynamicProperties]
class TheGem_TemplatePostContent extends Widget_Base {
	...
	public function get_name() {
		return 'thegem-template-post-content';
	}
	...
	public function show_in_panel() {
		...
		return get_post_type($post_id) === 'thegem_templates' && thegem_get_template_type($post_id) === 'single-post';
	}
	...
	public function render() {
		...
		$params['text_styled'] = implode(' ', array($params['text_style'], $params['text_weight']));
		...
		if(!empty($return_html)) {
			$return_html = '<div class="'.esc_attr($params['element_class']).'"><div class="post-content '.$params['text_styled'].'">'.$return_html.'</div></div>';
		}
...
\Elementor\Plugin::instance()->widgets_manager->register(new TheGem_TemplatePostContent());
