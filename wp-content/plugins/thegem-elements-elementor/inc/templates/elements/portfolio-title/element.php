...
namespace TheGem_Elementor\Widgets\TemplatePortfolioTitle;
...
class TheGem_TemplatePortfolioTitle extends Widget_Base {
	...
	public function get_name() {
		return 'thegem-template-portfolio-title';
	}
	...
	public function get_widget_wrapper() {
		return 'thegem-te-portfolio-title';
	}
	...
	public function get_customize_class($only_parent = false) {
		...
		return ' .'.$this->get_widget_wrapper().' .portfolio-title';
	}
	...
	public function render() {
		...
		$alignment = !empty($params['alignment']) ? 'title--'.$params['alignment'] : '';
        ...
        <div class="<?= esc_attr($params['element_class']); ?>">
            <<?= $params['text_tag'] ?> class="portfolio-title <?= $text_styled_class ?>">
...
\Elementor\Plugin::instance()->widgets_manager->register(new TheGem_TemplatePortfolioTitle());
