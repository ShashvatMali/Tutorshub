...
namespace TheGem_Elementor\Widgets\TemplatePortfolioNavigation;
...
class TheGem_TemplatePortfolioNavigation extends Widget_Base {
	...
	public function get_name() {
		return 'thegem-template-portfolio-navigation';
	}
	...
	public function get_title() {
		return __('Prev/Next Navigation', 'thegem');
	}
	...
	public function get_widget_wrapper() {
		return 'thegem-te-portfolio-navigation';
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'navigate_by',
			[
				'label' => __('Navigate by', 'thegem'),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'chronology' => __('Chronology', 'thegem'),
					'taxonomy' => __('Same Taxonomy', 'thegem'),
				],
				'default' => 'chronology',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => __('Previous Portfolio', 'thegem'),
				'condition' => [
					'label' => 'yes',
				],
			]
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::TEXT,
				'default' => __('Next Portfolio', 'thegem'),
				'condition' => [
					'label' => 'yes',
				],
			]
		...
		$this->start_controls_section(
			'section_title',
			[
				'label' => __('Portfolio Title', 'thegem'),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}}'.$this->get_customize_class().' a:hover .post-title span' => 'color: {{VALUE}};',
				],
			]
		);
	...
	public function render() {
		...
		$return_html = the_post_navigation( array(
...
\Elementor\Plugin::instance()->widgets_manager->register(new TheGem_TemplatePortfolioNavigation());
