...
<div class="tu-instructor-invoice-detail">
    <div class="tu-dbwrapper">
        ...
        <h4 style=""><?php esc_html_e("Invoice summary", "tuturn"); ?></h4>
        <table border="1" align="center">
            <tr>
            ...
            ?>
                ...
                <?php if (!empty($total_tax)) { ?>
                    <tr>
                        <td></td>
                        <td></td>
                        <td><?php esc_html_e('Tax including:', "tuturn") ?></td>
                        <td><?php echo tuturn_price_format($total_tax); ?></td>
                    </tr>
                <?php } ?>
                ...
                <?php if (!empty($payment_type) && $payment_type === 'booking' && !empty($total) && !empty($admin_commision)) { ?>
                    <tr>
                        <td></td>
                        <td></td>
                        <td><?php esc_html_e('Service fee:', "tuturn") ?></td>
                        <td><?php echo esc_html($admin_commision); ?>%</td>
                    </tr>
                <?php } ?>
            <?php } ?>
