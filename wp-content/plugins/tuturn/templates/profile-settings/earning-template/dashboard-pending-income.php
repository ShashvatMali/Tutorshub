...
$account_blance = tuturn_account_details($user_identity, array('wc-completed'), array('publish'));
...
<div class="tu-incomeitem">
    <div class="tu-incomeprice">
        <span class="tu-incomeicon tu-bgred"><i class="icon icon-clock tu-colorred"></i></span>
        <h5>
            <?php tuturn_price_format($account_blance); ?>
            <span><?php esc_html_e('Pending income', 'tuturn'); ?></span>
        </h5>
